...
vario.Epaisseur = variogram(Epaisseur~1,BDdepot2)
...
vario.Epaisseur = variogram(Epaisseur~1, BDdepot2, cutoff = 1200, width = 100, cloud = FALSE)
vario.Epaisseur #déclarer la variable = créer un type "gstat.variogram"
...
write.table(vario.Epaisseur, file = "C:/Users/Amélie/Desktop/Formation_ISA/export/vario_Epaisseur.txt",sep=";")
...
library(rgdal) 
writeGDAL(Epaisseur.kriged, "C:/Users/Amélie/Desktop/Formation_ISA/export/predict_Epaisseur.tiff", drivername="GTiff")
